  ...
  for (const track of tracks) {
    ...
    try {
      execSync(
        ...
        // shorter than the clips they narrate, and without padding
        // `-shortest` truncates the VIDEO down to the audio's length.
        // Padding makes the audio effectively endless so `-shortest` cuts
