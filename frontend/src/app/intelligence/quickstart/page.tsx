  ...
  return (
    <>
      ...
      <Panel title="What it demonstrates">
        ...
        <div className="mt-4">
          <TryIt
            prompts={["What is the weather in Berlin today?"]}
            expect="The reply streams normally. Every request in the network tab is a POST to /api/copilotkit-single carrying a { method, params, body } envelope — no /info, /agent/my_agent/run, or /threads paths at all."
