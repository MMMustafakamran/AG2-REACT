    ...
    <>
      ...
      <Panel title="What it demonstrates">
        ...
        <p className="mt-4 text-sm text-slate-600 dark:text-slate-400">
          ...
          , and the page&apos;s setup step —{" "}
          <code>import &quot;@copilotkit/react-core/v2/styles.css&quot;</code>{" "}
          in the root layout — is what this repo does in{" "}
          <code>src/app/layout.tsx</code>. No <code>@copilotkit/react-ui</code>{" "}
          anywhere; that is the v1 package.
        </p>
      ...
      <Panel title="Customization is the slots system">
        <p className="text-sm leading-relaxed text-slate-700 dark:text-slate-300">
          The page closes with a <code>CopilotChat</code> carrying{" "}
          <code>input</code> and <code>messageView</code> objects of Tailwind
          class strings. That is the first of the three levels the{" "}
          <a
          ...
          route exercises in full — class strings, prop overrides, and whole
          component replacement. Worth noting that Slots is not in the AG2
          sidebar at all, so the only in-nav pointer to that system is this
          five-line snippet.
        </p>
      </Panel>
