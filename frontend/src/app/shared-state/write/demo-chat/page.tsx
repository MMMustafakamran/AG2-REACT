...
export default function Page() {
  ...
  // accepted. `LANGUAGE_DEFAULTS` in `backend/main.py` still merges *under*
  // whatever state the browser sent, which is what keeps `setState` below from
  // being overwritten on the next run.
